...
public class Array {
	...
	//public void user_has_already_logged_in(io.cucumber.datatable.DataTable dataTable) {
	...
	//public void user_is_on_the_home_page_of_url(String string, String string2) {
	...
	//public void user_should_navigate_to_page_that_contains_title(String string) {
	    
	//}

	//@When("User clicks Try Here button of {string}")
	//public void user_clicks_try_here_button_of(String string) {
	...
	public void user_clear_the_text_editor() {
	 
	}

	@When("The user write code in PracQn Editor from sheetname {string} and rownumber {int}")
	public void the_user_write_code_in_prac_qn_editor_from_sheetname_and_rownumber(String string, Integer int1) {
