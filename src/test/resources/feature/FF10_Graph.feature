...
Feature: Graph Functionality with login
  ...
  @Graph11
  Scenario: Check User able to Directed to Graph page from Dropdown in Graph page
    Given User is in Graph page
    When click on the dropdown and select Graph
    Then The user should be on Graph Page

  @Graph12
  Scenario: Check User able to Directed to Satck page from Dropdown in Graph page
    Given User is in Graph page
    When click on the dropdown and select Stack
    Then The user should be directed to Stack Page

  @Graph13
  Scenario: Check User able to Directed to Queue page from Dropdown in Graph page
    Given User is in Graph page
    When click on the dropdown and select Queue
    Then The user should be directed to Queue Page

  @Graph14
  Scenario: Check User able to Directed to Tree page from Dropdown in Graph page
    Given User is in Graph page
    When click on the dropdown and select Tree
    Then The user should be directed to Tree Page

  @Graph15
  Scenario: Check User able to Directed to Array page from Dropdown in Graph page
    Given User is in Graph page
    When click on the dropdown and select Array
    Then The user should be directed to Array Page

  @Graph16
  Scenario: Check User is on same Linked List from Dropdown in Graph page
    Given User is in Graph page
    When click on the dropdown and select Linked List
    Then The user should be on Linked List Page

  @Graph17
  Scenario: Try Editor validation for Graph Topic with no testcode
    Given User is in "Text Editor" page with run through Graph page
    When User clicks on run button without entering code
    Then User should be on Same page

  @Graph18
  Scenario: Try Editor validation for Graph Representation Topic with no testcode
    Given User is in "Text Editor" page with run through Graph Representation page
    When User clicks on run button without entering code
    Then User should be on Same page
